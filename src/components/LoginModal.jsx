...
export default function LoginModal() {
  ...
  <div className="window-body flex justify-around">
    ...
    <div>
      ...
      <div className="mt-3">
        <div className="field-row justify-between" style={{width: '200px'}}>
        ...
        <div className="field-row justify-end" style={{width: '200px'}}>
          ...
          <input className="self-end" id="text19" type="text" />
        </div>
      </div>
    </div>

    <div className="flex flex-col">
      <button className="mt-1 keyBind" onClick={() => console.log(crypto.randomUUID())}>OK</button>
      <button className="mt-1 keyBind" disabled>Cancelar</button>
    </div>
  </div>
</div>
